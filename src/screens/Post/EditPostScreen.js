...
import { styles } from "./EditPostStyles";
...
import { updatePostData } from "../../controllers/userControllers";
    ...
    const SavePostData = async () => {
        if (!postImage) {
            ...
            if (hasNullValues) {
                ...
                await updatePostData(item.idpost, NewPost);
                Alert.alert('Sửa bài viết thành công !!');
                clearData();
                navigation.goBack();
            }
        }
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity onPress={SavePostData}>
                        <Text style={{ fontWeight: "500", fontSize: 20, color: "black" }}>Sửa Bài</Text>
                    </TouchableOpacity>
                </View>
